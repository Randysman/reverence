...
def order_create(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            order = Order(user=request.user, first_name=form.cleaned_data.get('first_name'),
            ...
            for item in cart:
                ...
                OrderItem.objects.create(order=order, clothing_item=item['item'], size=size_instance, quantity=item['quantity'], total_price=item['total_price'],)
            try:
